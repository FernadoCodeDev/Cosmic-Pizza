...
<template>
    <svg fill="currentcolor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 47.82 47.82" xml:space="preserve">
        ...
        <g id="SVGRepo_iconCarrier">
            <g>
                <g>
                    <path
                        d="M15.78,34.176c0.075,0.695,0,1.418,0,1.418h15.296c0,0,0-0.705,0-1.627c3.754-0.588,10.979-6.721,10.979-6.721H4.834 C4.834,27.246,10.746,33.328,15.78,34.176z">
                    </path>
                    <path
                        d="M28.848,12.227c-2.356,0-8.937,0-10.704,0c-1.771,0-4.315,3.172-4.315,3.172h19.231 C33.061,15.398,31.205,12.227,28.848,12.227z">
                    </path>
                    <path
